...
```bash
kubectl create -n argo -f examples/hello-world.yaml
...
```bash
kubectl apply -n argo -f examples/cron-hello-world.yaml
...
- `examples/cron-hello-world.yaml` は 5 分ごとに Workflow を起動します。停止するときは `kubectl delete -n argo -f examples/cron-hello-world.yaml` を実行してください。
